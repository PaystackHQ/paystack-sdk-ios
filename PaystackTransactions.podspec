...
Pod::Spec.new do |s|
  s.name             = 'PaystackTransactions'
  s.version          = '0.1.0'
  s.summary          = 'Transactions functionality from the Paystack Public iOS SDK'

# TODO: Add correct descriptions

  s.description      = "This is an iOS library used to access Paystack Transaction functionality"
  ...
  s.source_files = 'Sources/PaystackSDK/API/Transactions/**/*.{h,m,swift}'
